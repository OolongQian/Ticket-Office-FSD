...
public:
  ...
  void get_range(const KeyType &low, const KeyType &high, ValType arr[], int &len, KeyType *arr_k = nullptr,
                 bool get_key = false);
...
template<class KeyType, class ValType>
typename BPlusTree<KeyType, ValType>::retT BPlusTree<KeyType, ValType>::erase_node(BPlusTree::Node &cur, const KeyType &K)  {
...
template<class KeyType, class ValType>
KeyType BPlusTree<KeyType, ValType>::split_branch(BPlusTree::Node &B, BPlusTree::Node &B_next) {
#ifdef LOG
...
template<class KeyType, class ValType>
void BPlusTree<KeyType, ValType>::split_leaf(BPlusTree::Node &L, BPlusTree::Node &L_next) {
#ifdef LOG
...
template<class KeyType, class ValType>
bool BPlusTree<KeyType, ValType>::insert_in_leaf(BPlusTree::Node &cur, const KeyType &K, const ValType &V) {
#ifdef LOG
...
template<class KeyType, class ValType>
typename BPlusTree<KeyType, ValType>::retT BPlusTree<KeyType, ValType>::insert_node(BPlusTree::Node &cur, const KeyType &K, const ValType &V){
    if (cur.isLeaf) {
...
template<class KeyType, class ValType>
short BPlusTree<KeyType, ValType>::find_child(BPlusTree::Node &cur, const KeyType K, BPlusTree::Node &child) {
    short i = cur.search_sup(K);
...
template<class KeyType, class ValType>
void BPlusTree<KeyType, ValType>::search_to_leaf(KeyType K, BPlusTree::Node &ret) {
    bm.get_root(ret);
...
template<class KeyType, class ValType>
BPlusTree<KeyType, ValType>::BPlusTree() {
...
template<class KeyType, class ValType>
BPlusTree<KeyType, ValType>::BPlusTree(const char *fname) {
    strcpy(filename, fname);
    bm.set_fileName(fname);
...
template<class KeyType, class ValType>
ValType BPlusTree<KeyType, ValType>::find(const KeyType &K) {
//            if(cnt >= 20)
...
template<class KeyType, class ValType>
void
BPlusTree<KeyType, ValType>::get_range(const KeyType &low, const KeyType &high, ValType *arr, int &len, KeyType *arr_k,
                                       bool get_key)  {
    len = 0;
...
template<class KeyType, class ValType>
bool BPlusTree<KeyType, ValType>::modify(KeyType K, ValType V) {
    ...
    if (keyPos == -1) {
        ...
        cnt--;
        bm.record_basic_info();
        return true;
    }
}

template<class KeyType, class ValType>
bool BPlusTree<KeyType, ValType>::insert(const KeyType &K, const ValType &V){
#ifdef LOG
    static int cnt = 0;
			cnt++;
...
template<class KeyType, class ValType>
bool BPlusTree<KeyType, ValType>::erase(KeyType K) {
    if (bm.root_off == -1) {
